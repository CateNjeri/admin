                    ...
                    <el-tab-pane label="Event Information">
                        <el-row :gutter="20">
                            <el-col :sm="24" :xs="24" :md="24" :lg="12">
                                <el-form labelPosition="left" ref="eventInformation" :rules="eventFormRules" :model="eventForm" label-width="120px">
                                    ...
                                    <el-row>
                                        <el-col :xs="24" :sm="24" :md="24" :lg="24">
                                            <el-form-item label="Date" prop="date">
                                                <el-date-picker v-model="eventForm.date" type="daterange" placeholder="Pick dates">
                                                </el-date-picker>
                                            </el-form-item>
                                        </el-col>
                                    </el-row>
                                    <el-form-item label="Location" prop="location">
                                        <el-input v-model="eventForm.location" clearable placeholder="Location">
                                        </el-input>
                                    </el-form-item>
                                    ...
                                    <el-form-item>
                                        ...
                                        <el-button type="primary" @click="saveEventInformation" :loading="savingEventInformation">Save
                                        </el-button>
                                    </el-form-item>
                                </el-form>
                            </el-col>
                            <el-col :sm="24" :xs="24" :md="24" :lg="12">
                                ...
                                <el-upload class="picture-card" list-type="picture-card" v-bind:action="uploadUrl" :show-file-list="false" :on-success="onEventImageUpload" :before-upload="uploadEventImage" style="padding-left: 78px; width: 80px; height:100px;">
                    ...
                    <el-tab-pane label="Event Tickets" v-if="eventForm.id!==-1">
                        <el-row :gutter="20">
                            <el-col :xs="24" :sm="24" :md="24" :lg="12">
                                <el-form ref="eventTicketForm" :model="eventTicketForm" label-width="120px" labelPosition="left">
                                    <el-form-item label="Option">
                                        <el-select v-model="eventTicketForm.ticket_option_id" placeholder="please select your option">
                                    ...
                                    <el-form-item label="Price">
                                        <el-input v-model="eventTicketForm.amount" placeholder="in Ksh."></el-input>
                                    </el-form-item>
                                    <el-form-item>
                            ...
                            <el-col :xs="24" :sm="24" :md="24" :lg="12">
                                <el-table height="250" :data="eventTickets" border style="width: 100%">
                    ...
                    <el-tab-pane label="Merchandise" v-if="eventForm.id!==-1">
                        <el-row :gutter="20">
                            <el-col :xs="24" :sm="24" :md="24" :lg="12">
                                ...
                                <el-form ref="merchandiseForm" :model="merchandiseForm" label-width="120px" labelPosition="left">
                                    ...
                                    <el-form-item label="Image">
                                        <el-upload :action="uploadUrl" list-type="picture-card" :before-upload="uploadMerchandiseImage" :on-preview="handlePictureCardPreview" :on-remove="handleRemove">
                            ...
                            <el-col :xs="24" :sm="24" :md="24" :lg="12">
                                <el-table height="250" :data="merchandises" border style="width: 100%">
          ...
          /*         if (this.eventForm.image) {
           ...
           return false
            ...
            uploadMerchandisImage(file) {
                ...
                uploadFile({
                    data: data,
                    url: this.getMerchandiseImageUploadUrl(),
                    method: 'post'
                }).then((res) => {
