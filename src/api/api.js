...
let base ='http://ticketpay.wizhub.co.ke/ticket-pay-api/public/api/admin';
 ...
 *Banners
 **/
export const addBanners = params => {
 ...
 *OrderProducts
 **/
export const getAllSales = params => {
    return axios.get(`${base}/sales`,params);
}
export const getAllActiveSales = params => {
    return axios.get(`${base}/paidSales`,params);
}
export const getAllPendingSales = params => {
    return axios.get(`${base}/unpaidSales`,params);
}
export const getAllValidatedSales = params => {
    return axios.get(`${base}/validatedSales`,params);
}
export const getSumSales = params => {
    return axios.get(`${base}/sumAmountCollected`,params);
}

export const getTotalActiveSales = params => {
    return axios.get(`${base}/totalSalesActive`,params);
}
export const getTotalPendingSales = params => {
    return axios.get(`${base}/totalSalesPending`,params);
}
export const getTotalValidatedSales = params => {
    return axios.get(`${base}/totalSalesValidated`,params);
}

export const showdata = params => {
    return axios.get(`${base}/showdata`,params);
}
